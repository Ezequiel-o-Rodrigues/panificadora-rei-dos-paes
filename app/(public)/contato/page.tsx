  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-20 sm:px-6">
      ...
      {TENANT_CONFIG.contato.telefone && (
        <p className="mt-4 text-lg text-onyx-700">
          Telefone:{" "}
      ...
      {instagramUrl && (
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="mt-8 inline-flex items-center gap-2 rounded-full bg-gradient-to-br from-flame-400 via-flame-500 to-rust-500 px-6 py-3 text-sm font-bold text-white shadow-flame transition hover:shadow-glow-lg"
        >
